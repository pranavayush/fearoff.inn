...
export default function TeacherLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    const result = validateLogin(username, password, "teacher");
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 flex items-center justify-center p-4 animate-gradient">
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full transform transition-all duration-300 hover:shadow-3xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl mb-2 text-gray-800">Teacher Login</h1>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-200"
        ...
        <div className="mt-6 text-center space-y-2">
          <p className="text-gray-600">
            ...
            <Link to="/teacher-register" className="text-green-500 hover:text-green-600 hover:underline transition-colors">
              Register here
            </Link>
          </p>
