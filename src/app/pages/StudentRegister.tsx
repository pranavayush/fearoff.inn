...
import { UserCircle, Mail, User, Lock, ArrowRight } from "lucide-react";
      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full transform transition-all duration-300 hover:shadow-3xl">
        ...
        <div className="mt-6 text-center space-y-2">
          <p className="text-gray-600">
            ...
            <Link to="/student-login" className="text-blue-500 hover:text-blue-600 hover:underline transition-colors">
              Login here
            </Link>
          </p>
